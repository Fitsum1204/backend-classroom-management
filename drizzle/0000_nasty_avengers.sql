...
--> statement-breakpoint
ALTER TABLE "subjects" ADD CONSTRAINT "subjects_department_id_departements_id_fk" FOREIGN KEY ("department_id") REFERENCES "public"."departements"("id") ON DELETE restrict ON UPDATE no action;